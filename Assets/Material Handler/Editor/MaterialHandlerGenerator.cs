...
namespace Project.MaterialControl.EditorScript {
    ...
    public class MaterialHandlerGenerator : EditorWindow {
        ...
        private const string NAME_SPACE = "Project.MaterialControl";
        ...
        [MenuItem(
            "Tools/Material/Material Handler Generator"
        )]
            ...
            using (new EditorGUI.IndentLevelScope()) {
                ...
                if (_shader != null) {
                    ...
                    using (new EditorGUILayout.HorizontalScope()) {
                        ...
                        //}
                        // CLEARボタン
                        using (new EditorGUI.DisabledScope(string.IsNullOrEmpty(generatedClassText))) {
                ...
                // Previewテキスト表示
                if (!string.IsNullOrEmpty(generatedClassText)) {
                    EditorGUILayout.Space();
        ...
        private string GenerateMaterialHandlerClassText(Shader shader) {
            ...
            writer.WriteLine($"namespace {NAME_SPACE}");
            writer.WriteLine("{");
